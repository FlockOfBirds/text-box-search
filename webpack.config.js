...
const widgetConfig = {
    ...
    output: {
        ...
        filename: `src/com/mendix/widget/custom/textboxsearch/${widgetName}.js`,
        libraryTarget: "umd"
    },
    resolve: {
        extensions: [ ".ts", ".js" ],
    ...
    plugins: [
        ...
        new ExtractTextPlugin({ filename: `./src/com/mendix/widget/custom/textboxsearch/ui/${widgetName}.css` }),
